...
from omni_fs_mcp.backend_manager import BackendConfig, BackendManager
...
class TestBackendConfig:
    ...
    def test_valid_config(self):
        ...
        config = BackendConfig(
            name="test", url="memory:///", description="Test backend", readonly=False
        )
...
class TestBackendManager:
    ...
    def test_get_backend_default(self):
        ...
        manager.register_backend(
            name="test", url="memory:///", validate_connection=False
        )
    ...
    def test_set_default_backend(self):
        ...
        manager = BackendManager()
        manager.register_backend(
            name="test1", url="memory:///", validate_connection=False
        )
        manager.register_backend(
            name="test2", url="memory:///", validate_connection=False
        )
    ...
    def test_get_backend_stats(self):
        ...
        manager = BackendManager()
        manager.register_backend(
            name="test", url="memory:///", readonly=True, validate_connection=False
        )
